...
public class ViewRendererService : IViewRendererService
{
    ...
    public ViewRendererService(IRazorViewEngine viewEngine, ITempDataProvider tempDataProvider, IServiceProvider serviceProvider, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public async Task<string> RenderViewToStringAsync(string viewNameOrPath)
    {
        return await RenderViewToStringAsync(viewNameOrPath, string.Empty);
    }
